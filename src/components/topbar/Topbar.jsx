...
export default function Topbar() {
    ...
    const renderMobileMenu = (
        ...
        >
            <MenuItem>
                <IconButton size="large" aria-label="show 4 new persons" color="inherit">
        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="fixed">
                <Toolbar>
                    ...
                    <ButtonGroup color='inherit' variant='text' sx ={{display: { xs: 'none', sm: 'block'  }}}>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        <IconButton
                            size="large"
                            aria-label="show 17 new persons"
                            color="inherit"
                        >
                            <Badge badgeContent={17} color="error">
                                <Person />
